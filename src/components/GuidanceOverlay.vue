<template>
  <div class="absolute bottom-24 left-4 right-4 flex flex-col items-center gap-2 pointer-events-none">
    ...
    <!-- Issue chips — shown after calibration -->
...
.guidance-icon { font-size: 16px; flex-shrink: 0; }
.guidance-good {
...
.chip-enter-active, .chip-leave-active { transition: opacity 0.3s ease, transform 0.3s ease; }
.chip-enter-from, .chip-leave-to { opacity: 0; transform: translateY(8px); }
</style>
